...
pub const ARENA_WIDTH: f32 = 150.0;
pub const ARENA_HEIGHT: f32 = 150.0;
...
fn initialise_camera(world: &mut World) {
    // Setup camera so screen covers whole arena and (0, 0) is at bottom left.
...
// Initialize paddle on left and right
